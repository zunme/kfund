...
#openevent .container:before{
  ...
  width: 200px;
  height:50px;
  background: url(/assets/img/event_top.png);
...
.event-img-col, .event-present-box, .event-first, .event-sec, .event-third{
  height:250px;
}
.event-present-box{
  margin:auto;
...
.event-first, .event-sec, .event-third{
  position: relative;
 z-index: 8;
...
<link href="https://fonts.googleapis.com/css?family=Alfa+Slab+One|Asset|Black+Ops+One|Chela+One|Ewert|Fascinate+Inline|Lobster|Plaster|Sonsie+One|Righteous" rel="stylesheet">
  <!-- EVENT -->
<div id="openevent" class="main_section openevent">
  <div class="container">
    <div>
<div class="row"><div class="col-xs-12"  style="box-shadow:0 0 10px 1px rgba(0,0,0,0.2);border-top-right-radius: 10px;border-bottom-left-radius: 10px;background-color:white">
    <div class="row">
      <div class="col-xs-6 event-img-col triangle-right">
        <div class="event-present-box">
          <img src="/assets/img/shinsegae10000_1.jpg">
        </div>
      </div>

      <div class="col-xs-6 event-first">
        <!--div class="arrow-right"></div-->
        <p class="event-p1">신규가입 1+1 이벤트</p>
          <div class="event-desc-col">
            <p class="event-p2">일만원 지급</p>
            <p class="event-p3">신규가입 후 1만원 예치하시는 모든 분께 일만원 신세계 상품권을 드립니다.</p>
          </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xs-6 event-sec">
        <p class="event-p1">카카오 친구추가 이벤트</p>
        <div class="event-desc-col">
          <p class="event-p2">스타벅스 카페라떼</p>
          <p class="event-p3">카카오톡 친구추가 하시는 회원님들께 카페라떼 쿠폰을 드립니다.</p>
        </div>
      </div>
      <div class="col-xs-6 event-img-col triangle-left">
        <div class="event-present-box">
          <img src="/assets/img/m_cupon.png">
        </div>
      </div>
    </div>
	<div class="row">
	      <div class="col-xs-6 event-img-col triangle-right" style="border-bottom-left-radius: 10px;">
	        <div class="event-present-box">
	          <img src="/assets/img/shinsegae5000_1.jpg">
	        </div>
	      </div>

	      <div class="col-xs-6 event-third">
	        <!--div class="arrow-right"></div-->
	        <p class="event-p1">SNS 후기 이벤트</p>
	          <div class="event-desc-col">
	            <p class="event-p2">오천원 지급</p>
	            <p class="event-p3">SNS로 이벤트를 홍보해주시는 분께 오천원 신세계 상품권을 드립니다.</p>
	          </div>
</div></div>
      </div>
    </div>
    <div style="padding-top:30px;">
      <a href="/pnpinvest/?mode=bbs_view&type=view&table=notice&id=5" class="btn btn-rose" style="font-size: 20px;padding: 10px 30px;margin-top: 20px;margin-bottom: 30px;"><i class="fas fa-gift" style="padding-right: 10px;"></i> 이벤트 자세히 보기</a>
    </div>
  </div>
  </div>
</div>
